...
/*!
  ...
  * License MIT
  */
!function(a){function d(a){var c=b["$"+a]||window[a];if(!c)throw new Error("Requested module '"+a+"' has not been defined.");return c}function e(a,c){return b["$"+a]=c}function f(a,b){for(var c in b)c!="noConflict"&&c!="_VERSION"&&(a[c]=b[c]);return a}function g(a,b,c){return typeof a=="undefined"?c=[]:typeof a=="string"||a.nodeName||a.length&&"item"in a||a==window?(c=h._select(a,b),c.selector=a):c=isFinite(a.length)?a:[a],f(c,g)}function h(a,b){return g(a,b)}a.global=a;var b={},c=a.$;a.provide=e,a.require=d,h._VERSION="0.3.7",f(h,{fn:g,ender:function(a,b){f(b?g:h,a)},_select:function(a,b){return typeof a=="string"?(b||document).querySelectorAll(a):a.nodeName?[a]:a}}),f(g,{forEach:function(a,b,c,d){for(c=0,d=this.length;c<d;++c)c in this&&a.call(b||this[c],this[c],c,this);return this},$:h}),h.noConflict=function(){return a.$=c,this},typeof module!="undefined"&&module.exports&&(module.exports=h),a.ender=a.$=a.ender||h}(this),!function(){var a={exports:{}},b=a.exports;
/*!
...
/*!
    ...
    */
!function(a){function d(){var a,c,e,f,g,h=arguments[0],i=1,j=arguments.length;for(;i<j;i+=1)if((a=arguments[i])!==null)for(c in a){e=h[c],f=a[c];if(h===f)continue;f&&b.obj(f)?(g=e&&b.obj(e)?e:{},h[c]=d(g,f)):f!==undefined&&(h[c]=f)}return h}function e(a){if(null===a||"object"!=typeof a)return a;var b=a.constructor(),c;for(c in a)a.hasOwnProperty(c)&&(b[c]=a[c]);return b}function f(a,b){var c=Array.prototype.slice,d=c.call(arguments,2);return function(){return a.apply(b,d.concat(c.call(arguments)))}}function g(a){var b=a.el,e=a.complete?a.complete:function(){},f,g;if(!a.animation||!(b.animate||a.css3transition&&c)){b.css(a.fallbackCss),e();return}a.animStartCss&&(a.animStartCss.opacity===0&&(a.animStartCss.opacity=.01),b.css(a.animStartCss)),f=a.animation,a.css3transition&&c?(g=b[0].offsetWidth,b[0].style[c.prop]="all "+f.duration+"ms ease-out",delete f.duration,b.css(f),b.bind(c.end,function(){b.unbind(c.end),b[0].style[c.prop]="none",e()})):window.ender?b.animate(d(f,{complete:e})):b.animate(f,f.duration,"swing",e)}function h(a){this.init(a)}function i(a,b){return this.init(a,b),this.getApi()}var b,c;b={fun:function(a){return typeof a=="function"},arr:function(a){return a instanceof Array},obj:function(a){return a instanceof Object&&!b.fun(a)&&!b.arr(a)}},c=function(){var a=document.createElement("div").style,b="TransitionEnd",c="Transition",d=a.transition!==undefined||a.WebkitTransition!==undefined||a.MozTransition!==undefined;return d&&{prop:function(){return a.WebkitTransition!==undefined?c="WebkitTransition":a.MozTransition!==undefined&&(c="MozTransition"),c}(),end:function(){return a.WebkitTransition!==undefined?b="webkitTransitionEnd":a.MozTransition!==undefined&&(b="transitionend"),b}()}}(),h.prototype={init:function(b){this.options={id:"ender-overlay-mask",zIndex:9998,opacity:.6,color:"#777"},d(this.options,b||{});var c=a("#"+this.options.id),e=this.options;c.length||(c=a("<div></div>").attr("id",this.options.id).css({display:"none",position:"absolute",top:0,left:0}).appendTo("body")),this.$mask=c},show:function(){var a=this.options,b=this.getDocSize(),c=!1;this.$mask.css({zIndex:a.zIndex,backgroundColor:a.color,width:b.width,height:b.height}),a.durationIn&&(c={opacity:a.opacity,duration:a.durationIn}),g({el:this.$mask,animStartCss:{opacity:.01,display:"block"},animation:c,fallbackCss:{display:"block",opacity:a.opacity},css3transition:a.css3transition})},hide:function(){var a=this.options,b=this,c=!1;a.durationOut&&(c={opacity:0,duration:a.durationOut}),g({el:this.$mask,animation:c,complete:function(){b.$mask.css({display:"none"})},fallbackCss:{display:"none"},css3transition:a.css3transition})},getDocSize:function(){return window.ender?{width:a("body").width(),height:a.doc().height}:{width:a(document).width(),height:a(document).height()}},getMask:function(){return this.$mask}},i.prototype={init:function(a,b){this.options={top:80,position:"absolute",cssClass:"ender-overlay",close:".close",trigger:null,zIndex:9999,showMask:!0,closeOnEsc:!0,closeOnMaskClick:!0,autoOpen:!1,allowMultipleDisplay:!1,css3transition:!1,startAnimationCss:{opacity:.01},animationIn:{opacity:1,duration:250},animationOut:{opacity:0,duration:250},mask:{},onBeforeOpen:function(){},onBeforeClose:function(){},onOpen:function(){},onClose:function(){}},this.setOptions(b),this.$overlay=a.css({display:"none"}),this.options.showMask&&(this.mask=new h(this.options.mask)),this.$overlay.attr("data-overlayloaded")||(this.attachEvents(),this.$overlay.attr("data-overlayloaded",1)),this.options.autoOpen&&this.open()},attachEvents:function(){var b=this,c=this.options;c.trigger&&a(c.trigger).length&&a(c.trigger).click(function(a){a.preventDefault(),b.open()}),this.$overlay.delegate(c.close,"click",function(a){a.preventDefault(),b.close()}),a(document).bind("ender-overlay.close",function(){b.close()}),a(document).bind("ender-overlay.closeOverlay",function(){b.close(!0)}),c.closeOnEsc&&a(document).keyup(function(a){b.onKeyUp(a)}),this.mask&&c.closeOnMaskClick&&this.mask.getMask().click(function(){b.close()})},setupOverlay:function(){var b=this.options,c=b.top,d=a(window).scrollTop(),e=this.$overlay.width();this.$overlay.addClass(b.cssClass).appendTo("body"),b.position==="absolute"&&(c+=d),e===0&&(this.$overlay.css({display:"block",position:"absolute",left:-9999}),e=this.$overlay.width()),this.$overlay.css({display:"none",position:b.position,top:c,left:"50%",zIndex:b.zIndex,marginLeft:e/2*-1})},open:function(b){var c=this.options,f=this,h=c.animationIn?e(c.animationIn):!1,i=this.getApi();if(this.$overlay.css("display")==="block"||c.onBeforeOpen(i)===!1)return;this.setupOverlay(),c.allowMultipleDisplay||a(document).trigger("ender-overlay.closeOverlay"),g({el:this.$overlay,animStartCss:d({display:"block"},c.startAnimationCss),animation:h,complete:function(){h&&h.opacity===1&&f.$overlay.css({filter:""}),f.options.onOpen(i)},fallbackCss:{display:"block",opacity:1},css3transition:c.css3transition}),this.mask&&typeof b=="undefined"&&this.mask.show()},close:function(a){var b=this.options,c=this,d=b.animationOut?e(b.animationOut):!1,f=this.getApi();if(b.onBeforeClose(f)===!1||this.$overlay.css("display")!=="block")return;g({el:this.$overlay,animation:d,complete:function(){c.$overlay.css({display:"none"}),c.options.onClose(f)},fallbackCss:{display:"none",opacity:0},css3transition:b.css3transition}),this.mask&&typeof a=="undefined"&&this.mask.hide()},onKeyUp:function(a){a.keyCode===27&&this.$overlay.css("display")!=="none"&&this.close()},getOverlay:function(){return this.$overlay},getOptions:function(){return this.options},setOptions:function(a){d(this.options,a||{});var b=this.options;b.animationIn==="none"&&(b.animationIn=!1),b.animationOut==="none"&&(b.animationOut=!1),b.showMask&&(!b.mask.durationIn&&b.animationIn&&b.animationIn.duration&&(b.mask.durationIn=b.animationIn.duration),!b.mask.durationOut&&b.animationOut&&b.animationOut.duration&&(b.mask.durationOut=b.animationOut.duration),!b.mask.durationIn&&!b.animationIn&&(b.mask.durationIn=0),!b.mask.durationOut&&!b.animationOut&&(b.mask.durationOut=0),typeof b.mask.css3transition!="boolean"&&(b.mask.css3transition=b.css3transition))},getApi:function(){return{open:f(this.open,this),close:f(this.close,this),getOverlay:f(this.getOverlay,this),getOptions:f(this.getOptions,this),setOptions:f(this.setOptions,this)}}},a.fn.overlay=function(b){var c=a(this).first();return new i(c,b)}}(window.ender||window.jQuery),provide("ender-overlay",a.exports)}()